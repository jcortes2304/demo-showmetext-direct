...
export default function HomePage() {
    ...
    const [wordsTosSend, setWordsTosSend] = useState<number>(0);
    ...
    useEffect(() => {
        ...
        subtitlesClient.onConnect = () => {
            const newSubscription = subtitlesClient.subscribe(`${BASE_TOPIC}/subtitles/0`, (message) => {
                ...
                if (subtitleMessage) {
                    const subtitles = subtitleMessage.subtitles;
                    const text = subtitles.map(line => line.texts.map(text => text.characters).join(" ")).join("\n");
        ...
        setSubtitlesClient(subtitlesClient);
    ...
    return (
        <div className="p-2">
            ...
            <div className="mx-auto p-4 flex flex-col md:flex-row">
                ...
                <div
                    className="w-full border border-gray-400 m-2 rounded-md overflow-y-auto max-h-[600px] min-h-[200px]">
                ...
                {/*            <span className="absolute inset-0 bg-blue-200 opacity-50 rounded"></span>*/}
